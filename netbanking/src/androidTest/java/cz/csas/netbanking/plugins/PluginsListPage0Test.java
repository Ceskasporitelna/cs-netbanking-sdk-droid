 ...
 * @since 02.09.16.
 */
public class PluginsListPage0Test extends NetbankingTest {
    ...
    @Test
    public void testPluginsListPage0() {
        mNetbankingClient.getPluginsResource().list(new PaginatedParameters(new Pagination(0, 1)),

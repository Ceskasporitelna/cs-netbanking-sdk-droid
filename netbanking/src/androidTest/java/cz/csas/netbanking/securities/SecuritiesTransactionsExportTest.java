 ...
 * @since 31.08.16.
 */
public class SecuritiesTransactionsExportTest extends NetbankingTest {

    private final String X_JUDGE_CASE = "securities.withId.transactions.export";
    ...
    @Test
    public void testSecuritiesTransationsExport() {

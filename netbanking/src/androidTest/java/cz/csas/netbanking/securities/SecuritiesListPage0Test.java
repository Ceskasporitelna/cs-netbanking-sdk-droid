 ...
 * @since 31.08.16.
 */
public class SecuritiesListPage0Test extends NetbankingTest {
    ...
    @Test
    public void testSecuritiesPage0List() {
        mNetbankingClient.getSecuritiesResource().list(new PaginatedParameters(new Pagination(0, 1)), new CallbackWebApi<SecuritiesListResponse>() {
            @Override

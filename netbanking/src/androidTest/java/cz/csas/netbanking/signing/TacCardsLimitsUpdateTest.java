 ...
 * @since 24.05.16.
 */
public class TacCardsLimitsUpdateTest extends NetbankingTest {
    ...
    public void testSigning() {
        ...
        assertEquals("160429968745872", signingObject.getSignId());
        ...
        assertEquals("160429968745872", mFilledSigningObject.getSignId());

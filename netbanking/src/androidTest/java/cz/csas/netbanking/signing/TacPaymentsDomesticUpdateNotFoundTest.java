 ...
 * @since 24.05.16.
 */
public class TacPaymentsDomesticUpdateNotFoundTest extends NetbankingTest {
    private final String X_JUDGE_CASE = "signing.tac.payments.domestic.create.id.notFound";
    ...
    public void testSigning() {
        ...
        mNetbankingClient.getOrdersResource().getPaymentsResource().getDomesticResource().create(request, new CallbackWebApi<DomesticPaymentCreateResponse>() {
            @Override
            public void success(DomesticPaymentCreateResponse domesticPaymentUpdateResponse) {
        ...
        assertEquals("50da529ae64891cf37add6f9e5aa2a83353efcd77ac756973cff30234a1e3e6b", signingObject.getSignId());

        assertEquals("160418930050871", payment.getId());
        ...
        assertEquals("50da529ae64891cf37add6f9e5aa2a83353efcd77ac756973cff30234a1e3e6b", payment.signing().getSignId());
        ...
        assertNull(mFilledSigningObject);
        assertNotNull(mError);
        assertEquals(mError.getKind(), CsSigningError.Kind.INVALID_SIGN_ID);
    }
}

 ...
 * @since 24.05.16.
 */
public class TacCardsLimitsUpdateInvalidTest extends NetbankingTest {
    private final String X_JUDGE_CASE = "signing.tac.cards.limits.update.authorizationType.invalid";
    ...
    public void testSigning() {
        ...
        assertEquals("1445623886", signingObject.getSignId());
        ...
        assertEquals("1445623886", mFilledSigningObject.getSignId());

 ...
 * @since 24.05.16.
 */
public class TacPaymentsDomesticCreateOTPTest extends NetbankingTest {
    ...
    public void testSigning() {
        ...
        assertEquals("50da529ae64891cf37add6f9e5aa2a83353efcd77ac756973cff30234a1e3e6b", mFilledSigningObject.getSignId());
        ...
        mTacSigningProcess.finishSigning("123456", new CallbackWebApi<SigningObject>() {
            @Override
        ...
        assertEquals(mError.getKind(), CsSigningError.Kind.INVALID_OTP);
    }
}

 ...
 * @since 29.08.16.
 */
public class BuildingTransactionsExportTest extends NetbankingTest {
    private final String X_JUDGE_CASE = "contracts.buildings.withId.transactions.export";
    ...
    @Test
    public void testBuildingWithIdTransactionsExport() {
        ...
        ExportTransactionsParameters parameters = new ExportTransactionsParameters.Builder()
                ...
                .build();
        mNetbankingClient.getContractsResource().getBuildingsResource().withId(buildingId).getTransactionsResource()

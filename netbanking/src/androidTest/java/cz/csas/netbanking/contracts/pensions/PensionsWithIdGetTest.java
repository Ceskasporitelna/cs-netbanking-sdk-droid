 ...
 * @since 29.08.16.
 */
public class PensionsWithIdGetTest extends NetbankingTest {
    private final String X_JUDGE_CASE = "contracts.pensions.withId.get";
    private CountDownLatch mCountDownLatch;
    private Pension mResponse;
    ...
    @Test
    public void testPensionsWithIdGet() {
        String id = "E7DD68AA3FF4487AF75626F901761B071E72FFFC";
        mNetbankingClient.getContractsResource().getPensionsResource().withId(id).get(new CallbackWebApi<Pension>() {
            @Override

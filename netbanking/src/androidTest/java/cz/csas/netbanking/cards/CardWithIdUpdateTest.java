 ...
 * @since 14.04.16.
 */
public class CardWithIdUpdateTest extends NetbankingTest {
    private final String X_JUDGE_CASE = "cards.withId.update";
    private CountDownLatch mCardsSignal;
    private ChangeCardSettingsResponse mChangeCardSettingsResponse;
    ...
    @Test
    public void testCardWithIdUpdate() {
        ...
        mNetbankingClient.getCardsResource().withId(cardId).update(request, new CallbackWebApi<ChangeCardSettingsResponse>() {
            @Override
            public void success(ChangeCardSettingsResponse card) {
                mChangeCardSettingsResponse = card;
        ...
        Card card = mChangeCardSettingsResponse;
        ...
        assertEquals(SigningState.NONE, mChangeCardSettingsResponse.signing().getSigningState());
    }

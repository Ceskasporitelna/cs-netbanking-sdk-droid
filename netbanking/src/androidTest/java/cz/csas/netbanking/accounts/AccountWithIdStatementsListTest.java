...
/**
 * The type Account with id statements list test.
 *
 * @author Frantisek Kratochvil <kratochvilf@gmail.com>
 * @since 12.04.16.
 */
public class AccountWithIdStatementsListTest extends NetbankingTest {

    private final String X_JUDGE_CASE = "accounts.withId.statements.list";
    ...
    /**
     * Test account with id statements.
     */
    @Test
    public void testAccountWithIdStatements() {

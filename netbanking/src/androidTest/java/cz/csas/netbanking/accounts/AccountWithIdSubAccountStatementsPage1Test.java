...
/**
 * The type Account with id sub account statements page 1 test.
 *
 * @author Frantisek Kratochvil <kratochvilf@gmail.com>
 * @since 13.04.16.
 */
public class AccountWithIdSubAccountStatementsPage1Test extends NetbankingTest {
    ...
    /**
     * Test account with id subaccount statements page 1 list.
     */
    @Test
    public void testAccountWithIdSubAccountStatementsPage1List() {

...
/**
 * The type Accounts with id reservations list test.
 *
 * @author Frantisek Kratochvil <kratochvilf@gmail.com>
 * @since 12.04.16.
 */
public class AccountsWithIdReservationsListTest extends NetbankingTest {
    private final String X_JUDGE_CASE = "accounts.withId.reservations.list";
    ...
    /**
     * Test account reservations list.
     */
    @Test
    public void testAccountReservationsList() {
        String accountId = "076E1DBCCCD38729A99D93AC8D3E8273237C7E36";
        mNetbankingClient.getAccountsResource().withId(accountId).getReservationsResource().list(null,

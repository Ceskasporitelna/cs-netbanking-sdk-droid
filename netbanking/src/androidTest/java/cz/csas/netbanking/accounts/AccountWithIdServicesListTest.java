 ...
 * @since 08.04.16.
 */
public class AccountWithIdServicesListTest extends NetbankingTest {
    private final String X_JUDGE_CASE = "accounts.withId.services.list";
    ...
    /**
     * Test account with ID services.
     */
    @Test
    public void testAccountWithIdServices() {

        String accountId = "076E1DBCCCD38729A99D93AC8D3E8273237C7E36";
        PaginatedParameters parameters = new PaginatedParameters(new Pagination(0, 2));

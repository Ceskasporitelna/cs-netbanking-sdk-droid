...
/**
 * The type Accounts transactions history test.
 *
 * @author Jan Hauser <jan.hauser@applifting.cz>
 * @since 22 /01/2018.
 */
public class AccountsTransactionsHistoryListPage1Test extends NetbankingTest {
    private final String X_JUDGE_CASE = "accounts.withId.transactionsHistory.list.page1";
    ...
    @Test
    public void testAccountTransactionsHistoryListPage1() {
        ...
        AccountTransaction transaction = mAccountTransactionsHistoryListResponse.getAccountTransactions().get(0);
        AccountParty accountParty = transaction.getAccountParty();
        Amount amount = transaction.getAmount();
        Amount amountSender = transaction.getAmountSender();

        assertEquals(transaction.getId(), "I141126DXHZ3U");

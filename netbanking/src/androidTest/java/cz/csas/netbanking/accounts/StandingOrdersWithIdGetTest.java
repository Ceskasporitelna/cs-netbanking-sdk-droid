 ...
 * @since 01.09.16.
 */
public class StandingOrdersWithIdGetTest extends NetbankingTest {
    private final String X_JUDGE_CASE = "accounts.withId.standingOrders.withId.get";
    private CountDownLatch mCountDownLatch;
    private StandingOrder mResponse;
    ...
    @Test
    public void testStandingOrderWithIdGet() {

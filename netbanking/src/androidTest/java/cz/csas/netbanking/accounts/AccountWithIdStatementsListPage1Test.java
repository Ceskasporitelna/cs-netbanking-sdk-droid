...
/**
 * The type Account with id statements list page 1 test.
 *
 * @author Frantisek Kratochvil <kratochvilf@gmail.com>
 * @since 12.04.16.
 */
public class AccountWithIdStatementsListPage1Test extends NetbankingTest {

    private final String X_JUDGE_CASE = "accounts.withId.statements.list.page1";
    ...
    /**
     * Test account with id statements page 1.
     */
    @Test
    public void testAccountWithIdStatementsPage1() {
        ...
        assertEquals(Long.valueOf(1), mStatementsListResponse.getPageNumber());
        ...
        assertEquals("06029392819b0197", statement.getId());
        assertEquals(Integer.valueOf(3), statement.getNumber());
